...
class LaneDetection:
    ...
    def callback(self,data):
        ...
        roi=hsv_image[roi_top:roi_bottom,roi_left:roi_right]
        ...
        if len(contours)>0 :
            self.hipass_mode=True
        else :
            self.hipass_mode=False
            ...
            if left_lane.size != 0 and right_lane.size != 0:  # 양쪽 차선 감지
                ...
                if L1_x==0 and L2_x ==0 :
                    ...
                    if L1_x==0 :
                        ...
                        if(self.hipass_mode):
                            print("-----------HIPASS-----------")
                            ct_error= int(L2_x-220) - center_x
                        else :
                        ...
                        if(self.hipass_mode):
                            print("-----------HIPASS-----------")
                            ct_error= int( L1_x + 220) - center_x
                        else :
                ...
                if left_lane.size!=0: #only왼쪽 감지
                    #usable?
                    L1_x = self.process_lane(left_lane, output_img)
                    print("only left L1_x : ",L1_x)
                    print("왼쪽차선이랑 중앙사이 간격 : ", center_x-L1_x)
